...
<hr/>
<footer>
  <center><p style="font-size:x-small">ProFTPd Admin <?php echo $ac->get_version(); ?>  is licensed under GPLv2. See <a href="https://github.com/Ronaldvr/ProFTPd-Admin-SQLite">github.com/Ronaldvr/ProFTPd-Admin-SQLite</a> for more information.</p></center>
</footer>
</div> <!-- /container -->
